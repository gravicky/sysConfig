...
return function(lang)
  ...
  lang({
    ...
    event = { 'CursorHold', 'CursorHoldI' },
    keymaps = { disabledDefaults = {}, useDefaults = true },
    forwardLooking = { small = 5, big = 10 },
    -- config = function()
  ...
  -- maybe includer rust_analyzer here so it auto downloads it, and make it rquired for rustaceanvim
